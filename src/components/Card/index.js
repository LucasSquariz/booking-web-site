                ...
                {!buscaCategoria ?
                    booking.map((a) =>
                        <div className="card" key={a.id}>
                            <div>
                                <Link to={`/produto/${a.id}`}><img className="img-card" src={a.url} alt={a.nome} onClick={() => pegarProduto(a.id)} ></img></Link>
                            </div>
                            <div className="texto">
                    ...
                    : buscaCategoria && escolhaCategoria != "" ? cardsSelecionados.map((a) =>
                        <div className="card" key={a.id}>
                            <div>
                                <Link to={`/produto/${a.id}`}><img className="img-card" src={a.url} alt={a.name} onClick={() => pegarProduto(a.id)}></img></Link>
                            </div>
                            <div className="texto">
                                <div className="avaliacao">
                                    <p> <span className="avaliacao-texto">Avaliação </span>
